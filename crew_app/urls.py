...
urlpatterns = [
    ...
    path('crew/gear/pd/', ProtectiveDeviceView.as_view(), name='ProtectiveDeviceView'),
    path('config/create_gear/pd/add/', CreateProtectiveDeviceView.as_view(), name='protective'),
    path('config/gear/update_gear/<int:pk>', UpdateProtectiveDeviceView.as_view(), name='update_gear'),
    path('config/create_gear/equip/add/', CreateEquipmentView.as_view(), name='create_equipment'),
    path('crew/gear/equip/', EquipmentView.as_view(), name='equipment_view'),
    path('config/crew/gear/update_equip/<int:pk>', UpdateEquipmentView.as_view(), name='update_equipment'),
